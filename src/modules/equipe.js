...
const datacpo = [
    ...
    //{texte:"Autres domaines d'expertise: démarrage, court terme, moyen terme, excellence.",                   text:"Other Domains of Expertise:",     extra_delay:false},
...
const datapierre = [
    ...
    {texte:"Expérience:",                                           text:"Creation Date: Jan 6 2020.",          extra_delay:true},
    {texte:"*** administrateur secteur bancaire 25 ans",            text:"Creation Date: Jan 6 2020.",          extra_delay:true},
    {texte:"*** administrateur IQ 10 ans",                          text:"Satisfied Customers: 100+",           extra_delay:false},
    {texte:"Forces: ",                                              text:"Strategic services offering based on: Enterprise Lifecycle",extra_delay:false},
    {texte:"*** démarrage (financement, plan de d'affaire, commercialisation)",     text:"Strategic services offering based on: Enterprise Lifecycle",extra_delay:false},
    {texte:"*** excellence (planification stratégique, rèleve)",     text:"Strategic services offering based on: Enterprise Lifecycle",extra_delay:false},
    {texte:"Faiblesse",                 text:"Specialized in: Reengineering",   extra_delay:false},
    {texte:"*** aucune",                 text:"Specialized in: Reengineering",   extra_delay:false},
];
            ...
            <div className="demo-3">
                <div className="main-wrap">
                    <div >
                        ...
                        <div ref="glitch" className="glitch glitch--style-1" ref="glitch">
                ...
                <Membres index={this.state.index}/>
            </div>
        )
    }
